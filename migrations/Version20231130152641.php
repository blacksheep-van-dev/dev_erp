 ...
 */
final class Version20231130152641 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE option_stock ADD options_id INT DEFAULT NULL, ADD enabled TINYINT(1) NOT NULL, ADD price INT NOT NULL, CHANGE option_id_id agency_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE option_stock ADD option_id_id INT DEFAULT NULL, DROP agency_id, DROP options_id, DROP enabled, DROP price');
