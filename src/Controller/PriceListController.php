...
class PriceListController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            // priceListPrices
            $priceListPrices = $data->getPriceListPrices();

            //dd($priceListPrices);

            // for each priceListPrice in priceListPrices PriceList addPriceListPrice
            foreach ($priceListPrices as $priceListPrice) {
                $priceList->addPriceListPrice($priceListPrice);

                // set priceList for each priceListPrice
                $priceListPrice->setPriceList($priceList);
